...
IsGabber("keldorn")~ THEN keldorn_PID
SAY @0
IF ~~ THEN EXIT
END

IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%)
IsGabber(Player2) !Alignment(Player2,MASK_EVIL)~ THEN player_2
SAY @1
IF ~~ THEN EXIT
END

IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%)
IsGabber(Player3) !Alignment(Player3,MASK_EVIL)~ THEN player_3
SAY @2
IF ~~ THEN EXIT
END

IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%)
IsGabber(Player4) !Alignment(Player4,MASK_EVIL)~ THEN player_4
SAY @3
IF ~~ THEN EXIT
END

IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%)
IsGabber(Player5) !Alignment(Player5,MASK_EVIL)~ THEN player_5
SAY @4
IF ~~ THEN EXIT
END

IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%)
IsGabber(Player6) !Alignment(Player6,MASK_EVIL)~ THEN player_6
SAY @5
IF ~~ THEN EXIT
END

IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%)
IsGabber(Player2) Alignment(Player2,MASK_EVIL)~ THEN player_2_evil
SAY @6
IF ~~ THEN EXIT
END

IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%)
IsGabber(Player3) Alignment(Player3,MASK_EVIL)~ THEN player_3_evil
SAY @1056
IF ~~ THEN EXIT
END

IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%)
IsGabber(Player4) Alignment(Player4,MASK_EVIL)~ THEN player_4_evil
SAY @1057
IF ~~ THEN EXIT
END

IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%)
IsGabber(Player5) Alignment(Player5,MASK_EVIL)~ THEN player_5_evil
SAY @1058
IF ~~ THEN EXIT
END

IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%)
IsGabber(Player6) Alignment(Player6,MASK_EVIL)~ THEN player_6_evil
SAY @1059
IF ~~ THEN EXIT
END
...
IF ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_8%)
IsGabber(Player1) Global("Slayer10","GLOBAL",2)~ THEN PID_slayer
SAY @7
IF ~~ THEN EXIT
END
...
Global("C#AjantinEilaPID","LOCALS",0)~ + @1010 DO ~SetGlobal("C#AjantinEilaPID","LOCALS",1)~ + eila_PID_01
+ ~Global("C#AjanEngagementBrokenBG1","GLOBAL",0)
Global("C#AjantisRomanceActive","GLOBAL",0) Global("C#AjanEnderoldQuest","GLOBAL",0)
Global("C#AjantisEilaSecondMeeting","GLOBAL",1)
Global("C#AjantinEilaPID","LOCALS",1)~ + @1010 + eila_PID_02
+ ~Global("C#AjanEngagementBrokenBG1","GLOBAL",0)
Global("C#AjantisRomanceActive","GLOBAL",0) Global("C#AjanEnderoldQuest","GLOBAL",0)
Global("C#AjantisEilaSecondMeeting","GLOBAL",1)
Global("C#AjantinEilaPID","LOCALS",2)~ + @1010 DO ~SetGlobal("C#AjantinEilaPID","LOCALS",3)~ + eila_PID_03
+ ~Global("C#AjanEngagementBrokenBG1","GLOBAL",0)
Global("C#AjantisRomanceActive","GLOBAL",0) Global("C#AjanEnderoldQuest","GLOBAL",0)
Global("C#AjantisEilaSecondMeeting","GLOBAL",1)
Global("C#AjantinEilaPID","LOCALS",3)~ + @1010 DO ~SetGlobal("C#AjantinEilaPID","LOCALS",4)~ + eila_PID_04
+ ~RandomNum(3,1) Global("C#AjanEngagementBrokenBG1","GLOBAL",0)
Global("C#AjantisRomanceActive","GLOBAL",0) Global("C#AjanEnderoldQuest","GLOBAL",0)
Global("C#AjantisEilaSecondMeeting","GLOBAL",1)
Global("C#AjantinEilaPID","LOCALS",4)~ + @1010 + eila_PID_05
+ ~RandomNum(3,2) Global("C#AjanEngagementBrokenBG1","GLOBAL",0)
Global("C#AjantisRomanceActive","GLOBAL",0) Global("C#AjanEnderoldQuest","GLOBAL",0)
Global("C#AjantisEilaSecondMeeting","GLOBAL",1)
Global("C#AjantinEilaPID","LOCALS",4)~ + @1010 + eila_PID_06
+ ~RandomNum(3,3) Global("C#AjanEngagementBrokenBG1","GLOBAL",0)
Global("C#AjantisRomanceActive","GLOBAL",0) Global("C#AjanEnderoldQuest","GLOBAL",0)
Global("C#AjantisEilaSecondMeeting","GLOBAL",1)
Global("C#AjantinEilaPID","LOCALS",4)~ + @1010 + eila_PID_07

+ ~OR(7)
Global("C#AjantisInfoSpellhold","LOCALS",0)
Global("C#AjantisInfoSpellhold2","LOCALS",0)
Global("C#AjantisAlreadyKnighted","LOCALS",0)
Global("C#AjantisWhatHappened","LOCALS",0)
Global("C#AjantisEleianaPID","LOCALS",0)
Global("C#AjantisFirkraagKidnapPID","LOCALS",0)
Global("C#AjantisRitterinnenPID","LOCALS",0)~ + @17 + PID_friendship_talk

+ ~PartyHasItem("C#AJ0008") Global("C#AjanEngagementBrokenBG1","GLOBAL",1)
Global("C#AjanEngBrokenBG1RingPID","LOCALS",0)~ + @1053 DO ~SetGlobal("C#AjanEngBrokenBG1RingPID","LOCALS",1)~ + broken_engagement_ring
...
Global("C#AjantisNBFlirtCycle","GLOBAL",4)~ + @919 DO ~SetGlobal("C#AjantisNBFlirtCycle","GLOBAL",6)~ + flirt_stop

+ ~GlobalGT("C#AjantisNBThinkingCycle","GLOBAL",8) Global("C#AjantisNBFlirtCycle","GLOBAL",6)~ + @1094 DO ~SetGlobal("C#AjantisNBFlirtCycle","GLOBAL",4)~ + flirt_start

+ ~GlobalLT("C#AjantisNBThinkingCycle","GLOBAL",9) Global("C#AjantisNBFlirtCycle","GLOBAL",6)~ + @1094 DO ~SetGlobal("C#AjantisNBFlirtCycle","GLOBAL",1)~ + flirt_start
...
+ ~OR(13)
	Global("C#AjantisInfoSpellhold","LOCALS",0)
	Global("C#AjantisInfoSpellhold2","LOCALS",0)
	Global("C#AjantisNBKeldorn1","LOCALS",1)
	Global("C#AjantisNBKeldorn2","LOCALS",1)
	Global("C#AjantisConfessionNewRom","LOCALS",2)
	Global("C#AjantisQueenOfBeauty","LOCALS",0)
	Global("C#AjantisWindspearBodyRom","LOCALS",1)
	Global("C#AjantisAlreadyKnighted","LOCALS",0)
	Global("C#AjantisWhatHappened","LOCALS",0)
	Global("C#AjantisEleianaPID","LOCALS",0)
	Global("C#AjantisFirkraagKidnapPID","LOCALS",0)
	Global("C#AjantisRitterinnenPID","LOCALS",0)
	Global("C#AjantisTravellingWife","LOCALS",0)~ + @17 + PID_new_beginnings_rom_talk
...
+ ~Global("C#AjantisInfoSpellhold","LOCALS",0) GlobalLT("Chapter","GLOBAL",%bg2_chapter_4%)~ + @1414 DO ~SetGlobal("C#AjantisInfoSpellhold","LOCALS",1)~ + spellhold_info

+ ~Global("C#AjantisInfoSpellhold2","LOCALS",0) GlobalLT("Chapter","GLOBAL",%bg2_chapter_4%)~ + @1415 DO ~SetGlobal("C#AjantisInfoSpellhold2","LOCALS",1)~ + spellhold_info_2

+ ~Global("C#AjantisAlreadyKnighted","LOCALS",0)~ + @37 DO ~SetGlobal("C#AjantisAlreadyKnighted","LOCALS",1)~ + ritterschlag_PID_nr_01

+ ~Global("C#AjantisWhatHappened","LOCALS",0)~ + @38 DO ~SetGlobal("C#AjantisWhatHappened","LOCALS",1)~ + ajantis_PID_nr_01

+ ~Global("C#AjantisEleianaPID","LOCALS",0)~ + @39 DO ~SetGlobal("C#AjantisEleianaPID","LOCALS",1)~ + eleiana_PID

+ ~Global("C#AjantisFirkraagKidnapPID","LOCALS",0)~ + @40 DO ~SetGlobal("C#AjantisFirkraagKidnapPID","LOCALS",1)~ + firkraag_kidnap_PID_01

+ ~Global("C#AjantisRitterinnenPID","LOCALS",0)~ + @41 DO ~SetGlobal("C#AjantisRitterinnenPID","LOCALS",1)~ + ritterinnen_PID_nr_01

++ @42 + PID_friendship
END

IF ~~ THEN spellhold_info
SAY @1413
= @756
IF ~OR(2)
	Global("C#AjantisRomanceActive","GLOBAL",3) 
	Global("C#AjantisRomanceActive","GLOBAL",0)~ THEN + PID_friendship_talk
IF ~Global("C#AjantisRomanceActive","GLOBAL",1) 
!Global("C#AjantisEngaged","GLOBAL",1)~ THEN + PID_new_beginnings_rom_talk
IF ~OR(2)
	Global("C#AjantisRomanceActive","GLOBAL",1)
	Global("C#AjantisRomanceActive","GLOBAL",2) 
Global("C#AjantisEngaged","GLOBAL",1)~ THEN + talk_engaged
END

IF ~~ THEN spellhold_info_2
SAY @1416
++ @1417 + spellhold_info_2_01
++ @1421 + spellhold_info_2_01
++ @1418 + spellhold_info_2_01
++ @1419 + spellhold_info_2_01
++ @1420 + spellhold_info_2_02
++ @1422 + spellhold_info_2_02
END

IF ~~ THEN spellhold_info_2_01
SAY @1423
IF ~~ THEN + spellhold_info_2_02
END
...
+ ~Global("C#AjantisInfoSpellhold","LOCALS",0)~ + @1414 DO ~SetGlobal("C#AjantisInfoSpellhold","LOCALS",1)~ + spellhold_info

+ ~Global("C#IM_ImoenStays","GLOBAL",0)
Global("C#AjantisInfoSpellhold2","LOCALS",0)
GlobalLT("Chapter","GLOBAL",%bg2_chapter_4%)~ + @1415 DO ~SetGlobal("C#AjantisInfoSpellhold2","LOCALS",1)~ + spellhold_info_2

+ ~!Global("C#IM_ImoenStays","GLOBAL",0)
Global("C#AjantisInfoSpellhold2","LOCALS",0)
GlobalLT("Chapter","GLOBAL",%bg2_chapter_4%)~ + @1452 DO ~SetGlobal("C#AjantisInfoSpellhold2","LOCALS",1)~ + spellhold_info_2_02

+ ~Global("LadyMaria","GLOBAL",5) Global("C#AjantisNBKeldorn1","LOCALS",1)~ + @1063 DO ~SetGlobal("C#AjantisNBKeldorn1","LOCALS",2)~ + keldorns_turmoil_LadyMaria5
+ ~Global("LadyMaria","GLOBAL",4) Global("C#AjantisNBKeldorn1","LOCALS",1)~ + @1063 DO ~SetGlobal("C#AjantisNBKeldorn1","LOCALS",2)~ + keldorns_turmoil_LadyMaria4
+ ~OR(2)
Global("LadyMaria","GLOBAL",4)
Global("LadyMaria","GLOBAL",5) Global("C#AjantisNBKeldorn2","LOCALS",1)~ + @1060 DO ~SetGlobal("C#AjantisNBKeldorn2","LOCALS",2)~ + keldorns_turmoil_02

+ ~Global("C#AjantisConfessionNewRom","LOCALS",2) Global("C#AjantisConfessionNewRom","LOCALS",1)~ + @124 + nearly_confession_PID_01

+ ~Global("C#AjantisQueenOfBeauty","LOCALS",0)~ + @1040 DO ~SetGlobal("C#AjantisQueenOfBeauty","LOCALS",1)~ + queen_beauty

+ ~Global("C#AjantisWindspearBodyRom","LOCALS",1)~ + @125 DO ~SetGlobal("C#AjantisWindspearBodyRom","LOCALS",2)~ + illusion_PID
...
+ ~Global("C#AjantisTravellingWife","LOCALS",0)~ + @126 DO ~SetGlobal("C#AjantisTravellingWife","LOCALS",1)~ + travelling_wife
...
SAY @1049
++ @1050 DO ~SetGlobal("C#Ajantis_NBRomRibbon","GLOBAL",1)~ + queen_beauty_04
...
SAY @131
IF ~~ THEN DO ~SetGlobal("C#AjantisConfessionNewRom","LOCALS",3)~ + PID_new_beginnings_rom_talk
END
...
IF ~~ THEN eila_PID_02
SAY @1013
IF ~Gender(Player1,male)~ THEN DO ~IncrementGlobal("C#AjantinEilaPID","LOCALS",1)~ EXIT
IF ~Gender(Player1,female)~ THEN DO ~IncrementGlobal("C#AjantinEilaPID","LOCALS",2)~ EXIT
END
...
SAY @202
IF ~Global("C#AjantisAlreadyKnighted","LOCALS",0)~ THEN DO ~SetGlobal("C#AjantisAlreadyKnighted","LOCALS",1)~ + ritterschlag_PID_nr_03
IF ~Global("C#AjantisAlreadyKnighted","LOCALS",1)~ THEN + ajantis_PID_nr_02
END
...
/* PID for "Ajantis is thinking", Global("C#AjantisIsThinking","GLOBAL",1) */
...
SAY @211
++ @1426 EXIT 
++ @1427 + reassurance_thinking
++ @204 + PID_rom_thinking_01

++ @1428 + PID_rom_thinking_02

+ ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_6%) ReputationGT(Player1,11) GlobalLT("C#AjantisWarUnzufrieden","GLOBAL",4) Global("C#AjantisVerlLoesenPID","LOCALS",0)~ + @206 DO ~SetGlobal("C#AjantisVerlLoesenPID","LOCALS",1)~ + PID_rom_thinking_03
+ ~GlobalGT("Chapter","GLOBAL",%bg2_chapter_5%) ReputationGT(Player1,15)
GlobalLT("C#AjantisWarUnzufrieden","GLOBAL",5) Global("C#AjantisVerlLoesenPID","LOCALS",0)~ + @206 DO ~SetGlobal("C#AjantisVerlLoesenPID","LOCALS",1)~ + PID_rom_thinking_03
+ ~GlobalLT("Chapter","GLOBAL",%bg2_chapter_6%) 
OR(2) ReputationLT(Player1,12) GlobalGT("C#AjantisWarUnzufrieden","GLOBAL",3) Global("C#AjantisVerlLoesenPID","LOCALS",0)~ + @206 DO ~SetGlobal("C#AjantisVerlLoesenPID","LOCALS",1)~ + PID_rom_thinking_04
+ ~GlobalGT("Chapter","GLOBAL",%bg2_chapter_5%) 
OR(2) ReputationLT(Player1,16)
GlobalGT("C#AjantisWarUnzufrieden","GLOBAL",4) Global("C#AjantisVerlLoesenPID","LOCALS",0)~ + @206 DO ~SetGlobal("C#AjantisVerlLoesenPID","LOCALS",1)~ + PID_rom_thinking_04

+ ~Global("C#AjantisVerlLoesenPID","LOCALS",0) Global("C#AjantisVerlLoesenLI","LOCALS",0)~ + @207 DO ~SetGlobal("C#AjantisVerlLoesenPID","LOCALS",1) SetGlobal("C#AjantisVerlLoesenLI","LOCALS",1) IncrementGlobal("C#Ajantis_ThinkingNegative","LOCALS",1)
IncrementGlobal("C#Ajantis_ThinkingNegative3","LOCALS",2)~ + PID_rom_thinking_05

+ ~Global("C#Ajantis_PID_rom_thinking_02","LOCALS",0)~ + @205 DO ~IncrementGlobal("C#Ajantis_ThinkingNegative","LOCALS",1) SetGlobal("C#Ajantis_PID_rom_thinking_02","LOCALS",1)~ + PID_rom_thinking_02

+ ~Global("C#Ajantis_PID_rom_thinking_02","LOCALS",1)~ + @205 + PID_rom_thinking_02
...
SAY @1430
IF ~RandomNum(4,1)~ THEN + hug_thinking_01
IF ~RandomNum(4,2)~ THEN + hug_thinking_02
IF ~RandomNum(4,3)~ THEN + hug_thinking_03
IF ~RandomNum(4,4)~ THEN EXIT
END

IF ~~ THEN hug_thinking_01
SAY @1431
IF ~~ THEN EXIT
END

IF ~~ THEN hug_thinking_02
SAY @1432
IF ~~ THEN EXIT
END

IF ~~ THEN hug_thinking_03
SAY @1433
IF ~~ THEN EXIT
END
...
OR(33)
	Global("C#AjantisInfoSpellhold","LOCALS",0)	
	Global("C#AjantisInfoSpellhold2","LOCALS",0)
	Global("C#AjantisVerlobVerlieren","LOCALS",1)
	Global("C#AjantisVerlobAngst","LOCALS",1)
	Global("C#AjantisSlayerFightMe","LOCALS",1)
	Global("C#AjanVerlWegschicken","LOCALS",1)
	Global("C#AjantisNachHochzeitPID","LOCALS",1)
	Global("C#AjantisSchildrueckgabe","LOCALS",1)
	Global("C#AjantisSchildrueckgabe","LOCALS",3)
	Global("C#AjantisDreamPID","GLOBAL",1)
	Global("C#AjanEllesimeDream1PID","GLOBAL",2)
	Global("C#AjantisJahaboamPID","LOCALS",1)
	Global("C#AjantisSchmuckbeutelPID","LOCALS",1)
	Global("C#AjantisDisinheritagePID","LOCALS",1)
	Global("C#AjantisAlreadyKnighted","LOCALS",0)
	Global("C#AjantisWhatHappened","LOCALS",0)
	Global("C#AjantisEleianaPID","LOCALS",0)
	Global("C#AjantisFirkraagKidnapPID","LOCALS",0)
	Global("C#AjantisWindspearBody","LOCALS",0)
	Global("C#AjantisRitterinnenPID","LOCALS",0)
	Global("C#AjantisHisSearchPID","LOCALS",2)
	Global("C#AjantisIlvastarrWedding","GLOBAL",0)
	Global("C#AjantisWeitergehenPID","LOCALS",2)
	Global("C#AjantisOrderPID","LOCALS",1)	
	Global("C#AjantisHochzeitsPlanen","GLOBAL",1)
	Global("C#AjantisWeddingRingsPID","LOCALS",1)
	Global("C#AjantisWeddingRingsPID","LOCALS",2)
	Global("C#AjantisMusterZurueckPID","LOCALS",1)
	Global("C#AjantisMusterbeutel","GLOBAL",1)
	Global("C#AjantisRingPID","LOCALS",1)
	Global("C#AjantisRingFarbe","GLOBAL",1)
	Global("C#AjantisWartetRingPID","LOCALS",1)
	Global("C#AjantisNeuerRingPID","LOCALS",1)~ + @17 + talk_engaged

+ ~!Global("C#AjantisEngaged","GLOBAL",1)
OR(2)
	Global("C#AjantisNBRingPID","LOCALS",1)
	Global("C#AjantisNBCTPID","LOCALS",0)~ + @17 + talk_nbRA2
...
IF ~~ THEN talk_nbRA2
SAY @510
+ ~Global("C#AjantisNBRingPID","LOCALS",1)~ + @937 DO ~SetGlobal("C#AjantisNBRingPID","LOCALS",2)~ + nb_ring_01
+ ~Global("C#AjantisNBRingPID","LOCALS",1)~ + @938 DO ~SetGlobal("C#AjantisNBRingPID","LOCALS",2)~ + nb_ring_02

+ ~Global("C#AjantisNBCTPID","LOCALS",0)~ + @943 DO ~SetGlobal("C#AjantisNBCTPID","LOCALS",1)~ + nb_confession_in_hell
...
+ ~Global("C#AjantisHochzeitsPlanen","GLOBAL",1)~ + @514 DO ~SetGlobal("C#AjantisHochzeitsPlanen","GLOBAL",2)
SetGlobal("C#AjantisLoveTalk","GLOBAL",28)~ + wedding_preparations_PID_00

+ ~!Global("C#AjantisHochzeitsPlanen","GLOBAL",2) Global("C#AjantisPCSAWWeddingRings","GLOBAL",1) Global("C#AjantisWeddingRingsPID","LOCALS",1)~ + @515 DO ~SetGlobal("C#AjantisWeddingRingsPID","LOCALS",2)~ + ehring_auswahl

+ ~!Global("C#AjantisHochzeitsPlanen","GLOBAL",2) Global("C#AjantisPCSAWWeddingRings","GLOBAL",1) Global("C#AjantisWeddingRingsPID","LOCALS",1)~ + @516 DO ~SetGlobal("C#AjantisWeddingRingsPID","LOCALS",2)~ + ehring_auswahl_04

+ ~Global("C#AjantisWeddingRingsPID","LOCALS",2)~ + @517 + ehring_auswahl_01

+ ~Global("C#AjantisMusterZurueck","GLOBAL",1) Global("C#AjantisMusterZurueckPID","LOCALS",1)~ + @520 DO ~SetGlobal("C#AjantisMusterZurueck","GLOBAL",0) SetGlobal("C#AjantisMusterZurueckPID","LOCALS",2)~ + musterbeutel_zurueck
+ ~Global("C#AjantisMusterZurueck","GLOBAL",2) Global("C#AjantisMusterZurueckPID","LOCALS",1)~ + @520 DO ~SetGlobal("C#AjantisMusterZurueck","GLOBAL",0) SetGlobal("C#AjantisMusterZurueckPID","LOCALS",2)~ + musterbeutel_zurueck_01

+ ~Global("C#AjantisMusterbeutel","GLOBAL",1)~ + @521 + musterbeutel_03

+ ~PartyHasItem("C#AJ0008") Global("C#AjantisRingPID","LOCALS",1)~ + @528 DO ~SetGlobal("C#AjantisRingPID","LOCALS",2)~ + ring_PID_01

+ ~!PartyHasItem("C#AJ0008") 
OR(2)
	Global("%NewSoAGame%","GLOBAL",1)
	GlobalGT("C#AjantisRomanceBG1Items","GLOBAL",0) 
Global("C#AjantisRingPID","LOCALS",1)~ + @529 DO ~SetGlobal("C#AjantisRingPID","LOCALS",2)~ + ring_PID_02

+ ~!PartyHasItem("C#AJ0008") 
Global("%NewSoAGame%","GLOBAL",0)
Global("C#AjantisRomanceBG1Items","GLOBAL",0) 
Global("C#AjantisRingPID","LOCALS",1)~ + @1443 DO ~SetGlobal("C#AjantisRingPID","LOCALS",2)~ + ring_PID_02a

+ ~!PartyHasItem("C#AJ0008") GlobalGT("C#AjantisRomanceBG1Items","GLOBAL",2) Global("C#AjantisRingPID","LOCALS",1)~ + @530 DO ~SetGlobal("C#AjantisRingPID","LOCALS",2)~ + ring_PID_05

+ ~PartyHasItem("C#AJ0008") Global("C#AjantisWartetRing","GLOBAL",1)
Global("C#AjantisWartetRingPID","LOCALS",1)~ + @531 + ring_schmieden_PID_01

+ ~PartyHasItem("C#AJ0008") Global("C#AjantisNeuerRing","GLOBAL",1)
Global("C#AjantisNeuerRingPID","LOCALS",1)~ + @532 + ring_schmieden_PID_02

+ ~Global("C#AjantisWartetRing","GLOBAL",1) Global("C#AjantisWartetRingPID","LOCALS",1)~ + @533 + ring_schmieden_PID_03
...
+ ~Global("C#AjantisVerlobVerlieren","LOCALS",1)~ + @1095 DO ~SetGlobal("C#AjantisVerlobVerlieren","LOCALS",2)~ + verlieren_engaged

/*PIDs nach Schlächterverwandlung:*/
+ ~Global("C#AjantisVerlobAngst","LOCALS",1)~ + @1096 DO ~SetGlobal("C#AjantisVerlobAngst","LOCALS",2)~ + slayer_angst_engaged

+ ~Global("C#AjantisSlayerFightMe","LOCALS",1)~ + @1097 DO ~SetGlobal("C#AjantisSlayerFightMe","LOCALS",2)~ + fight_slayer_engaged

+ ~Global("C#AjanVerlWegschicken","LOCALS",1)~ + @1098 DO ~SetGlobal("C#AjanVerlWegschicken","LOCALS",2)~ + slayer_wegschicken_engaged


+ ~Global("C#AjantisNachHochzeitPID","LOCALS",1)~ + @511 DO ~SetGlobal("C#AjantisNachHochzeitPID","LOCALS",2)~ + nach_hochzeit_PID_01

+ ~Global("C#AjantisSchildrueckgabe","LOCALS",1)~ + @512 DO ~SetGlobal("C#AjantisSchildrueckgabe","LOCALS",2)~ + schildrueckgabe
+ ~Global("C#AjantisSchildrueckgabe","LOCALS",1)~ + @513 DO ~SetGlobal("C#AjantisSchildrueckgabe","LOCALS",2)~ + schildrueckgabe

+ ~Global("C#AjantisDreamPID","GLOBAL",1)~ + @518 DO ~SetGlobal("C#AjantisDreamPID","GLOBAL",2)~ + traum_PID

+ ~Global("C#AjanEllesimeDream1PID","GLOBAL",2)~ + @519 DO ~SetGlobal("C#AjanEllesimeDream1PID","GLOBAL",3)~ + ellisime_dream_PID_01

+ ~Global("C#AjantisJahaboamPID","LOCALS",1)~ + @523 DO ~SetGlobal("C#AjantisJahaboamPID","LOCALS",2)~ + jahaboam_PID_01
+ ~Global("C#AjantisJahaboamNo","GLOBAL",1) Global("C#AjantisJahaboamPID","LOCALS",1)~ + @524 DO ~SetGlobal("C#AjantisJahaboamPID","LOCALS",2)~ + jahaboam_PID_02

+ ~Global("C#AjantisSchmuckbeutelPID","LOCALS",1) 
!Global("C#AjantisPCDontLikePresPID","LOCALS",1)~ + @525 DO ~SetGlobal("C#AjantisSchmuckbeutelPID","LOCALS",2)~ + schmuckbeutel_PID_01
+ ~Global("C#AjantisSchmuckbeutelPID","LOCALS",1) 
Global("C#AjantisPCDontLikePresPID","LOCALS",1)~ + @526 DO ~SetGlobal("C#AjantisSchmuckbeutelPID","LOCALS",2)~ + schmuckbeutel_PID_01
+ ~Global("C#AjantisSchmuckbeutelPID","LOCALS",1)~ + @527 DO ~SetGlobal("C#AjantisSchmuckbeutelPID","LOCALS",2)~ + schmuckbeutel_PID_02

+ ~Global("C#AjantisDisinheritagePID","LOCALS",1)~ + @535 DO ~SetGlobal("C#AjantisDisinheritagePID","LOCALS",2)~ + verstossung

+ ~Global("C#AjantisSchildrueckgabe","LOCALS",3)~ + @536 DO ~SetGlobal("C#AjantisSchildrueckgabe","LOCALS",4)~ + schildzurueck
+ ~Global("C#AjantisSchildrueckgabe","LOCALS",3)~ + @1445 DO ~SetGlobal("C#AjantisSchildrueckgabe","LOCALS",4)~ + schildzurueck

+ ~Global("C#AjantisAlreadyKnighted","LOCALS",0)~ + @37 DO ~SetGlobal("C#AjantisAlreadyKnighted","LOCALS",1)~ + ritterschlag_PID_01

+ ~Global("C#AjantisWhatHappened","LOCALS",0)~ + @38 DO ~SetGlobal("C#AjantisWhatHappened","LOCALS",1)~ + ajantis_PID_01

+ ~Global("C#AjantisEleianaPID","LOCALS",0)~ + @39 DO ~SetGlobal("C#AjantisEleianaPID","LOCALS",1)~ + eleiana_PID

+ ~Global("C#AjantisFirkraagKidnapPID","LOCALS",0)~ + @40 DO ~SetGlobal("C#AjantisFirkraagKidnapPID","LOCALS",1)~ + firkraag_kidnap_PID_01

+ ~Global("C#AjantisWindspearBody","LOCALS",0) Global("C#AjantisPCMarriage","GLOBAL",0)~ + @537 DO ~SetGlobal("C#AjantisWindspearBody","LOCALS",1) SetGlobal("C#AjantisWindspearBodyRom","LOCALS",1)~ + windspeerkampf_PID_06

+ ~Global("C#AjantisWindspearBody","LOCALS",0) Global("C#AjantisPCMarriage","GLOBAL",1)~ + @538 DO ~SetGlobal("C#AjantisWindspearBody","LOCALS",1) SetGlobal("C#AjantisWindspearBodyRom","LOCALS",1)~ + windspeerkampf_PID_06

+ ~Global("C#AjantisRitterinnenPID","LOCALS",0)  Global("C#AjantisRitterinnenAjan","GLOBAL",0)~ + @539 DO ~SetGlobal("C#AjantisRitterinnenPID","LOCALS",1)~ + ritterinnen_PID_01
+ ~Global("C#AjantisRitterinnenPID","LOCALS",0)  Global("C#AjantisRitterinnenAjan","GLOBAL",1)~ + @539 DO ~SetGlobal("C#AjantisRitterinnenPID","LOCALS",1)~ + ritterinnen_PID_02

+ ~Global("C#AjantisHisSearchPID","LOCALS",2)~ + @540 DO ~SetGlobal("C#AjantisHisSearchPID","LOCALS",3)~ + suche_PID_01

+ ~Global("C#AjantisIlvastarrWedding","GLOBAL",0)~ + @541 DO ~SetGlobal("C#AjantisIlvastarrWedding","GLOBAL",1)~ + wedding_PID_17

+ ~Global("C#AjantisWeitergehenPID","LOCALS",2)~ + @543 + weitergehen_PID_01

+ ~Global("C#AjantisOrderPID","LOCALS",1) Class(Player1, PALADIN)~ + @544 DO ~SetGlobal("C#AjantisOrderPID","GLOBAL",1)~ + order_01
+ ~Global("C#AjantisOrderPID","LOCALS",1) !Class(Player1, PALADIN)~ + @545 DO ~SetGlobal("C#AjantisOrderPID","GLOBAL",1)~ + order_01
...
SAY @575
++ @576 + nach_hochzeit_03
++ @577 + nach_hochzeit_04
++ @578 + nach_hochzeit_01
END
...
SAY @626
IF ~~ THEN DO ~SetGlobal("C#AjantisPCChoseRing","GLOBAL",1) SetGlobal("C#AjantisWeddingRingsPID","LOCALS",3)~ EXIT
END
...
IF ~~ THEN wedding_preparations_PID_00 //triggeres official lovetalk
SAY @629
IF ~~ THEN EXIT
END
...
SAY @699
IF ~~ THEN DO ~SetGlobal("C#AjantisMusterbeutel","GLOBAL",2)~ + talk_engaged
END

IF ~~ THEN musterbeutel_05
SAY @192
IF ~~ THEN + talk_engaged
END
...
SAY @754
++ @755 DO ~SetGlobal("C#AjantisWeitergehenPID","LOCALS",3)~ + weitergehen_PID_02
++ @757 DO ~SetGlobal("C#AjantisWeitergehenPID","LOCALS",3)~ + weitergehen_PID_03
END
...
SAY @795
IF ~PartyHasItem("C#AJ0007")~ THEN + ajantis_PID_01_1
IF ~!PartyHasItem("C#AJ0007")~ THEN + ajantis_PID_10
END

IF ~~ THEN ajantis_PID_01_1
SAY @1425
++ @796 + ajantis_PID_02
++ @797 DO ~SetGlobal("C#AjantisAlreadyKnighted","LOCALS",1)~ + ajantis_PID_03
END

IF ~~ THEN ajantis_PID_02
SAY @798
IF ~Global("C#AjantisAlreadyKnighted","LOCALS",0)~ THEN DO ~SetGlobal("C#AjantisAlreadyKnighted","LOCALS",1)~ + ajantis_PID_04
IF ~Global("C#AjantisAlreadyKnighted","LOCALS",1)~ THEN + ajantis_PID_05
END
...
SAY @812
++ @796 + ajantis_PID_02
+ ~Global("C#AjantisAlreadyKnighted","LOCALS",0)~ + @813 DO ~SetGlobal("C#AjantisAlreadyKnighted","LOCALS",1)~ + ajantis_PID_11
+ ~Global("C#AjantisAlreadyKnighted","LOCALS",1)~ + @814 + ajantis_PID_11a
END
...
SAY @881
= @1438
IF ~!Global("C#AjantisRingFarbe","GLOBAL",1)~ THEN DO ~SetGlobal("C#AjantisWartetRing","GLOBAL",2) TakePartyItem("C#AJ0008") DestroyItem("C#AJ0008") SetGlobal("C#AjantisSchmiedetRing","GLOBAL",1) EraseJournalEntry(@10004)~ + talk_engaged
...
SAY @882
= @1438
IF ~!Global("C#AjantisRingFarbe","GLOBAL",1)~ THEN DO ~SetGlobal("C#AjantisNeuerRing","GLOBAL",2) SetGlobal("C#AjantisNeuerRingPID","LOCALS",2) TakePartyItem("C#AJ0008") DestroyItem("C#AJ0008") SetGlobal("C#AjantisSchmiedetRing","GLOBAL",1)~ + talk_engaged
IF ~Global("C#AjantisRingFarbe","GLOBAL",1)~ THEN DO ~SetGlobal("C#AjantisNeuerRing","GLOBAL",2) SetGlobal("C#AjantisNeuerRingPID","LOCALS",2) TakePartyItem("C#AJ0008") DestroyItem("C#AJ0008") SetGlobal("C#AjantisSchmiedetRing","GLOBAL",1)~ + ring_schmieden_PID_04
END

IF ~~ THEN ring_schmieden_PID_03
SAY @192
= @883
IF ~!Global("C#AjantisRingFarbe","GLOBAL",1)~ THEN DO ~SetGlobal("C#AjantisNeuerRing","GLOBAL",1) SetGlobal("C#AjantisWartetRing","GLOBAL",2)
SetGlobal("C#AjantisWartetRingPID","LOCALS",2) EraseJournalEntry(@10004)~ + talk_engaged
IF ~Global("C#AjantisRingFarbe","GLOBAL",1)~ THEN DO ~SetGlobal("C#AjantisNeuerRing","GLOBAL",1) SetGlobal("C#AjantisWartetRing","GLOBAL",2)
SetGlobal("C#AjantisWartetRingPID","LOCALS",2) EraseJournalEntry(@10004)~ + ring_schmieden_PID_04
END
...
SAY @889
IF ~~ THEN DO ~EraseJournalEntry(@10003)~ + talk_engaged
END
