...
== KAYL2 IF ~GlobalLT("C#AjantisIsDeadBG1","GLOBAL",3)
...
ADD_TRANS_TRIGGER ~KAYL2~ 33 ~GlobalGT("C#AjantisIsDeadBG1","GLOBAL",2)~
...
+ ~GlobalLT("C#AjantisIsDeadBG1","GLOBAL",3)~ + @24 + KAYL2_report_33_1
END

ADD_TRANS_TRIGGER ~KAYL2~ 34 ~GlobalGT("C#AjantisIsDeadBG1","GLOBAL",2)~
...
+ ~GlobalLT("C#AjantisIsDeadBG1","GLOBAL",3)~ + @25 + KAYL2_report_34_1
END

ADD_TRANS_TRIGGER ~KAYL2~ 35 ~GlobalGT("C#AjantisIsDeadBG1","GLOBAL",2)~
...
+ ~GlobalLT("C#AjantisIsDeadBG1","GLOBAL",3)~ + @25 + KAYL2_report_35_1
END
...
SAY @63 
IF ~Global("C#AjantisExistiert","GLOBAL",1) InPartyAllowDead("C#Ajantis")~ THEN DO ~SetGlobal("C#AjantisQuestBelohnung","GLOBAL",1) ReputationInc(1)
GiveItemCreate("C#AJ0012",[PC],1,0,0) 
AddexperienceParty(10000)
SetGlobal("C#ReportFirkraagsTod","GLOBAL",1) 
GiveGoldForce(500) 
...
SAY @97 
IF ~Global("C#AjantisExistiert","GLOBAL",1) InPartyAllowDead("C#Ajantis")~ THEN DO ~
SetGlobal("C#ReportFirkraagsTod","GLOBAL",1) 
GiveGoldForce(500) 
